 ...
 */
public class DatacenterSimpleDynamic extends CloudSimEntity implements Datacenter {
     ...
     */
    public DatacenterSimpleDynamic(final Simulation simulation, final List<? extends Host> hostList) {
     ...
     */
    public DatacenterSimpleDynamic(
    ...
    private boolean processVmEvents(final SimEvent evt) {
        switch (evt.getTag()) {
            case CloudSimTags.VM_CREATE_ACK:
                ...
                if(vm.isCreated()) {
                    // TODO: process VM for specific host -----------------------------------------------------------------
    ...
    public boolean equals(final Object object) {
        ...
        final DatacenterSimpleDynamic that = (DatacenterSimpleDynamic) object;
