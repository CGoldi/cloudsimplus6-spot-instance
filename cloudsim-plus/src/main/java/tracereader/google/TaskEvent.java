...
import tracereader.google.GoogleTaskUsageTraceReader;
 ...
 */
public final class TaskEvent extends tracereader.google.TaskData {
    ...
    protected tracereader.google.TaskEvent setPriority(final int priority) {
    ...
    /* default */ tracereader.google.TaskEvent setResourceRequestForCpuCores(final double resourceRequestForCpuCores) {
    ...
    /* default */ tracereader.google.TaskEvent setResourceRequestForRam(final double resourceRequestForRam) {
    ...
    /* default */ tracereader.google.TaskEvent setResourceRequestForLocalDiskSpace(final double resourceRequestForLocalDiskSpace) {
    ...
    /* default */ tracereader.google.TaskEvent setUserName(final String userName) {
    ...
    protected tracereader.google.TaskEvent setTimestamp(final double timestamp) {
    ...
    /* default */ tracereader.google.TaskEvent setSchedulingClass(final int schedulingClass) {
     ...
     * @return
     */
    public tracereader.google.TaskEvent setType(final int type) {
