...
import tables.TableBuilderAbstract;
...
public class CloudletsTableBuilder extends TableBuilderAbstract<Cloudlet> {
    ...
    protected void createTableColumns() {
        final String ID = "ID";
        addColumnDataFunction(getTable().addColumn("                    Cloudlet", "Identifier"), Identifiable::getId);
        ...
        addColumnDataFunction(getTable().addColumn("        Host", "Identifier"), cloudlet -> cloudlet.getVm().getHost().getId());
        addColumnDataFunction(getTable().addColumn("Host PEs ", CPU_CORES), cloudlet -> cloudlet.getVm().getHost().getWorkingPesNumber());
        addColumnDataFunction(getTable().addColumn("    Virtual Machine (VM)", "Identifier"), cloudlet -> cloudlet.getVm().getId());
