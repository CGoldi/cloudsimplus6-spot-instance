...
public class GoogleTaskEventsExample1 {
    private static final String TRACE_FILENAME = "S:/GoogleCluster/clusterdata-2011-2/task_events/adjusted/part-00000-of-00500_adjusted.csv";
    ...
    private Cloudlet createCloudlet(final TaskEvent event) {
        ...
        */
        System.out.println(event.getMachineId());
    ...
    private void printCloudlets(final DatacenterBroker broker) {
        ...
        new CloudletsTableBuilder(list, new CsvTable())
